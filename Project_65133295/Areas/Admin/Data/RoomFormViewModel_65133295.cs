...
namespace Project_65133295.Areas.Admin.Data
{
    public class RoomFormViewModel_65133295
    {
        ...
        // Address fields were removed from separate table in new schema.
        // If needed, address should be part of Room or User in the schema.
        public int? MaxOccupancy { get; set; }
        public int StatusID { get; set; }
        
        // For Select Lists
        // Addresses table removed in new schema; leaving placeholder for Statuses
